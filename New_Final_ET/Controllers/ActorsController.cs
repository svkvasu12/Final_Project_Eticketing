...
namespace New_Final_ET.Controllers
{
    public class ActorsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Bio,FileName,File,FileName")] Actor actor)
        {
            if (id != actor.Id)
            {
                return NotFound();
            }
            if (!String.IsNullOrEmpty(actor.FileName))
            {
                actor.File = _context.Actors.AsNoTracking().FirstOrDefault(actor => actor.Id == id).File;
            }
