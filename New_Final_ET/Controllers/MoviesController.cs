...
namespace New_Final_ET.Controllers
{
    public class MoviesController : Controller
    {
        ...
        internal Task GetMovieByIdAsync(int id)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Price,StartDate,EndDate,CinemaId,ProducerId,FileName,File,FileForm")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price,StartDate,EndDate,CinemaId,ProducerId,FileName,File,FileForm")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
            ...
            {
                movie.File = _context.Actors.AsNoTracking().FirstOrDefault(actor => actor.Id == id).File;
            }
            else if (movie.File == null)
            {
                byte[] bytes = null;
                using (MemoryStream ms = new MemoryStream())
                {
